...
const Activities = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Ultra-Luxury Header */}
            <div className="bg-white pt-40 pb-32 px-6 relative overflow-hidden border-b border-gray-100">
                <div className="max-w-7xl mx-auto relative">
                    ...
                    >
                        <div className="inline-flex items-center gap-4 bg-blue-50 text-blue-600 px-8 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.4em] mb-12 shadow-sm border border-blue-100">
                            Adventures in Cherai
                        </div>
                        <h1 className="text-7xl lg:text-[10rem] font-black text-blue-950 mb-10 tracking-tighter leading-[0.85] uppercase">
                            Signature <br /> <span className="text-blue-600 outline-text">Experiences</span>
                        </h1>
                        <p className="text-2xl text-gray-500 font-medium max-w-3xl mx-auto leading-relaxed italic">
            ...
            <div className="py-0">
                {activities.length > 0 ? activities.map((activity, idx) => (
                    <section
                        key={activity.id}
                        className={`py-32 border-b border-gray-50 last:border-0 ${idx % 2 !== 0 ? 'bg-blue-50/30' : 'bg-white'}`}
                    >
                        <div className="max-w-7xl mx-auto px-6">
                            <div className={`flex flex-col ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-24`}>
                                {/* Image Collage Side */}
                                <motion.div
                                ...
                                >
                                    <div className="relative h-[600px] w-full rounded-[4rem] overflow-hidden shadow-2xl">
                                        ...
                                        {/* Floating Badge */}
                                        <div className="absolute top-12 left-12 bg-white/95 backdrop-blur-md px-8 py-4 rounded-[2rem] shadow-2xl border border-white/50 flex items-center gap-4">
                                ...
                                >
                                    ...
                                    <h2 className="text-6xl font-black text-blue-950 mb-8 tracking-tighter uppercase leading-none">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center gap-12 pt-8 border-t border-gray-100">
                                        <div className="flex-1 text-left w-full">
                                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Activity Pass</p>
                                            <div className="flex items-baseline gap-2 mb-2">
                                                <span className="text-6xl font-black text-blue-600 tracking-tighter">₹{activity.price}</span>
                                        ...
                                        <button
                                            ...
                                            className="w-full sm:w-auto bg-blue-950 hover:bg-blue-600 text-white px-16 py-8 rounded-[2rem] font-black text-xl transition-all duration-500 shadow-3xl shadow-blue-950/20 active:scale-95 flex items-center justify-center gap-6 group/btn"
                                        >
            ...
            <div className="bg-blue-950 py-40 px-6 overflow-hidden relative">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <div className="bg-blue-600/10 w-24 h-24 rounded-[2.5rem] flex items-center justify-center text-blue-400 mx-auto mb-12 shadow-inner border border-blue-600/20">
                        <Target className="w-12 h-12" />
                    </div>
                    <h2 className="text-6xl font-black text-white mb-10 tracking-tighter uppercase italic">Your Safety, Guaranteed</h2>
