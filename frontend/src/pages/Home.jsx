    ...
    return (
        <div className="bg-white">
            ...
            <div className="relative h-screen overflow-hidden flex flex-col justify-center">
                ...
                <div className="relative max-w-7xl mx-auto px-6 w-full">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <div className="flex items-center gap-3 text-white font-black tracking-[0.3em] uppercase text-[10px] mb-8 bg-white/10 backdrop-blur-xl px-6 py-3 rounded-full border border-white/20 w-fit">
                            <MapPin className="w-4 h-4 text-emerald-400" /> Premium Kerala Tourism
                        </div>
                        <h1 className="text-7xl lg:text-9xl font-black text-white leading-[0.85] mb-10 tracking-tighter">
                            KERALAM <br />
                        ...
                        <p className="text-xl md:text-2xl text-white/80 font-medium max-w-2xl mb-12 leading-relaxed">
                            Experience the breathtaking harmony of pristine beaches and tranquil backwaters in one unforgettable journey.
                        </p>

                        <div className="flex flex-wrap gap-6 items-start">
                            <Link to="/hotels" className="bg-emerald-600 text-white px-10 py-5 rounded-full font-black text-lg hover:bg-emerald-500 transition-all flex items-center gap-3 shadow-xl">
                                Plan Your Trip <ArrowRight size={20} />
                            </Link>
                            <Link to="/cherai" className="bg-white/10 backdrop-blur-md text-white border border-white/30 px-10 py-5 rounded-full font-black text-lg hover:bg-white/20 transition-all">
                            ...
                            <motion.div
                                ...
                                className="bg-slate-900/80 backdrop-blur-xl border border-emerald-500/30 p-5 rounded-2xl text-white shadow-2xl shadow-emerald-900/50 min-w-[310px]"
                            >
                                {/* Header */}
            ...
            <AnimatePresence>
                {showWelcome && (
                    <motion.div
                        ...
                        className="fixed top-6 right-6 z-[100] w-[360px]"
                    >
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <h2 className="text-4xl lg:text-5xl font-black text-white mb-8 tracking-tighter">Live Safety Insights</h2>
            ...
            <div className="bg-[#020617] py-32 px-6 border-b border-white/5 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-blue-100/50 font-medium mt-6 text-xl max-w-2xl mx-auto">Our AI cameras and drone network currently secure major coastal destinations.</p>
                    </div>

                    <div className="relative w-full max-w-5xl mx-auto h-[600px] bg-slate-900/40 rounded-[3rem] border border-blue-500/10 flex items-center justify-center p-8 overflow-hidden backdrop-blur-sm group hover:border-blue-500/30 transition-all duration-700 shadow-2xl">
            ...
            <div className="bg-slate-950 py-32 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-20">
                        ...
                        <h2 className="text-5xl lg:text-7xl font-black text-white italic tracking-tighter uppercase leading-none">Real-Time <br />Pulse</h2>
                        <p className="text-white/40 font-medium mt-6 text-xl max-w-xl">Live crowd density, weather, and AI safety metrics compiled in real-time for your safe passage.</p>
                    </div>
                    <LiveSection />
                </div>
            </div>
            ...
            <div className="space-y-40 py-40">
                <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-6xl font-black text-orange-950 mb-8 tracking-tighter">Luxury Stays & <br />Coastal Retreats</h2>
            ...
            {/* ════════════════════════════════════════════════════════════════
                TRUST BANNER
            ════════════════════════════════════════════════════════════════ */}
            <div className="bg-emerald-600 py-32 mx-4 lg:mx-20 rounded-[4rem] mb-32 text-center relative overflow-hidden">
                <div className="relative z-10">
                    <h2 className="text-5xl lg:text-7xl font-black text-white mb-10 tracking-tighter italic uppercase">Ready for Your Next Adventure?</h2>
                    <p className="text-2xl text-white/80 font-medium mb-12 max-w-2xl mx-auto">Join thousands of travelers who trust us for a safe and memorable Kerala experience.</p>
                    <Link to="/signup" className="bg-white text-emerald-600 px-12 py-6 rounded-full font-black text-xl hover:bg-emerald-50 shadow-2xl">Get Your ID</Link>
                </div>
            </div>
        </div>
    );
